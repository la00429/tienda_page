...
import { getProduct, updateProduct } from '@/api/EcommerceApi.js';
...
const EditProductPage = () => {
        ...
        try {
            ...
            if (response.success && response.data) {
                ...
                setFormData({
                    ...
                    variants: product.variants?.length > 0 ? product.variants : [{ size: 'M', stock: 0 }]
                });
            }
        } catch (error) {
    ...
    return (
        <>
            <Helmet>
                <title>{`Editar ${formData.name} - Admin ProSport`}</title>
                <meta name="description" content="Editar producto en el catálogo de ProSport" />
            </Helmet>
            ...
            <main className="min-h-screen bg-background">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold mb-8">Editar producto</h1>
